// WAFPubMFCdllInfo.cpp : implementation file
//
...
void LoadString(CString& str, UINT nID)
{
...
void CPropTreeInfo::OnPaint() 
{
	...
	CPropTreelItem* pItem = m_pProp->GetFocusedItem();
