...
BEGIN_MESSAGE_MAP(CPropTreeItemEdit, CEdit)
	//{{AFX_MSG_MAP(CWAFPubMFCdllItemEdit)
	ON_WM_GETDLGCODE()
	ON_WM_KEYDOWN()
...
/////////////////////////////////////////////////////////////////////////////
// CWAFPubMFCdllItemEdit message handlers
...
void CPropTreeItemEdit::SetItemValue(LPARAM lParam)
{
	...
	if (lParam==0L)
	{
		TRACE0("CWAFPubMFCdllItemEdit::SetItemValue - Invalid lParam value\n");
		return;
	}
