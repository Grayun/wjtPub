...
BEGIN_MESSAGE_MAP(CUgGridBase,CUGCtrl)
	//{{AFX_MSG_MAP(CEcUgGridBase)
...
/////////////////////////////////////////////////////////////////////////////
// Standard CEcUgGridBase construction/destruction
CUgGridBase::CUgGridBase()
{
	...
	m_fontHead.CreateFont(12,  //nHeight        
		6,  //nWidth         
		0,  //nEscapement    
		0,  //nOrientation   
		600,  //nWeight        
...
//	Return:
//		<none>
void CUgGridBase::OnSheetSetup(int sheetNumber)
{
...
int CUgGridBase::OnCanMove(int oldcol,long oldrow,int newcol,long newrow)
{
...
int CUgGridBase::OnCanViewMove(int oldcol,long oldrow,int newcol,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newcol);
...
//	Return:
//		<none>
void CUgGridBase::OnHitBottom(long numrows,long rowspast,long rowsfound)
{
...
//	Return:
//		<none>
void CUgGridBase::OnHitTop(long numrows,long rowspast)
{
	UNREFERENCED_PARAMETER(numrows);
	UNREFERENCED_PARAMETER(rowspast);
}
...
int CUgGridBase::OnCanSizeCol(int col)
{
...
//	Return:
//		<none>
void CUgGridBase::OnColSizing(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
...
//	Return:
//		<none>
void CUgGridBase::OnColSized(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*width);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUgGridBase::OnCanSizeRow(long row)
{
...
//	Return:
//		<none>
void CUgGridBase::OnRowSizing(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUgGridBase::OnRowSized(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*height);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUgGridBase::OnCanSizeSideHdg()
{
	return TRUE;
}
...
int CUgGridBase::OnSideHdgSizing(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
int CUgGridBase::OnSideHdgSized(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUgGridBase::OnCanSizeTopHdg()
{
	return TRUE;
}
...
//		TRUE - to accept current new size
//		FALSE - to stop sizing, the size is either too large or too small
int CUgGridBase::OnTopHdgSizing(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//		TRUE - to accept new size
//		FALSE - to revert to old size
int CUgGridBase::OnTopHdgSized(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//	Return:
//		<none>
void CUgGridBase::OnColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void CUgGridBase::OnRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void CUgGridBase::OnCellChange(int oldcol,int newcol,long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
	UNREFERENCED_PARAMETER(oldrow);
...
//	Return:
//		<none>
void CUgGridBase::OnLeftColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void CUgGridBase::OnTopRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void CUgGridBase::OnViewMoved( int nScrolDir, long oldPos, long newPos )
{
...
//	Return:
//		<none>
void CUgGridBase::OnSelectionChanged(int startCol,long startRow,int endCol,long endRow,int blockNum)
{
...
//	Return:
//		<none>
void CUgGridBase::OnLClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	...
	// 发送消息
	HWND hWndParent = this->GetParent()->m_hWnd;
	...
	if (hWndParent != NULL)
	{
		::SendMessage(hWndParent, WM_UGGRID_LEFT_CLICKED, (WPARAM)hwnd, (LPARAM)&data);
	}
}
...
//	Return:
//		<none>
void CUgGridBase::OnRClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUgGridBase::OnDClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
	...
	if (hWndParent != NULL)
	{
		::SendMessage(hWndParent, WM_UGGRID_DCLICKED, (WPARAM)hwnd, (LPARAM)&data);
	}
...
//	Return:
//		<none>
void CUgGridBase::OnMouseMove(int col,long row,POINT *point,UINT nFlags,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUgGridBase::OnTH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUgGridBase::OnTH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUgGridBase::OnTH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CUgGridBase::OnSH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUgGridBase::OnSH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUgGridBase::OnSH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CUgGridBase::OnCB_LClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUgGridBase::OnCB_RClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUgGridBase::OnCB_DClicked(RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
	UNREFERENCED_PARAMETER(processed);
...
//	Return:
//		<none>
void CUgGridBase::OnKeyDown(UINT *vcKey,BOOL processed)
{
...
//	Return:
//		<none>
void CUgGridBase::OnKeyUp(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void CUgGridBase::OnCharDown(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void CUgGridBase::OnGetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUgGridBase::OnSetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*cell);
...
//	Return:
//		<none>
void CUgGridBase::OnDataSourceNotify(int ID,long msg,long param)
{
...
int CUgGridBase::OnCellTypeNotify(long ID,int col,long row,long msg,long param)
{
	UNREFERENCED_PARAMETER(ID);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CUgGridBase::OnEditStart(int col, long row,CWnd **edit)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	...
	if (hWndParent != NULL)
	{
		::SendMessage(hWndParent, WM_UGGRID_START_EDIT, (WPARAM)hwnd, (LPARAM)&data);
	}
...
int CUgGridBase::OnEditVerify(int col, long row,CWnd *edit,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int CUgGridBase::OnEditFinish(int col, long row,CWnd *edit,LPCTSTR string,BOOL& cancelFlag)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
	...
	if (hWndParent != NULL)
	{
		::SendMessage(hWndParent, WM_UGGRID_END_EDIT, (WPARAM)hwnd, (LPARAM)&data);
	}
...
int CUgGridBase::OnEditContinue(int oldcol,long oldrow,int* newcol,long* newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(*newcol);
...
//	Return:
//		<none>
void CUgGridBase::OnMenuCommand(int col,long row,int section,int item)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CUgGridBase::OnMenuStart(int col,long row,int section)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
DWORD CUgGridBase::OnGetContextHelpID( int col, long row, int section )
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
int CUgGridBase::OnHint(int col,long row,int section,CString *string)
{
	UNREFERENCED_PARAMETER(section);
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int CUgGridBase::OnVScrollHint(long row,CString *string)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int CUgGridBase::OnHScrollHint(int col,CString *string)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
DROPEFFECT CUgGridBase::OnDragEnter(COleDataObject* pDataObject)
{
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CUgGridBase::OnDragOver(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CUgGridBase::OnDragDrop(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUgGridBase::OnScreenDCSetup(CDC *dc,int section)
{
...
int CUgGridBase::OnSortEvaluate(CUGCell *cell1,CUGCell *cell2,int flags)
{
...
//	Return:
//		<none>
void CUgGridBase::OnTabSelected(int ID)
{
	UNREFERENCED_PARAMETER(ID);
}
...
//	Return:
//		<none>
void CUgGridBase::OnAdjustComponentSizes(RECT *grid,RECT *topHdg,RECT *sideHdg,
...
//	Return:
//		<none>
void CUgGridBase::OnDrawFocusRect(CDC *dc,RECT *rect)
{
...
COLORREF CUgGridBase::OnGetDefBackColor(int section)
{
	UNREFERENCED_PARAMETER(section);
...
//		<none>
//
void CUgGridBase::OnSetFocus(int section)
{
	UNREFERENCED_PARAMETER(section);
}
...
//	Return:
//		<none>
void CUgGridBase::OnKillFocus(int section, CWnd *pNewWnd)
{
	UNREFERENCED_PARAMETER(section);
}
...
BOOL CUgGridBase::OnColSwapStart(int col)
{
	UNREFERENCED_PARAMETER(col);
	return TRUE;
}
...
//		TRUE - to allow for the swap to take place
//		FALSE - to disallow the swap
BOOL CUgGridBase::OnCanColSwap(int fromCol,int toCol)
{
...
//	Return:
//		<none>
void CUgGridBase::OnColSwapped(int fromCol,int toCol)
{
	UNREFERENCED_PARAMETER(fromCol);
	UNREFERENCED_PARAMETER(toCol);
}
...
//	Return:
//		<none>
void CUgGridBase::OnTrackingWindowMoved(RECT *origRect,RECT *newRect)
{
	UNREFERENCED_PARAMETER(*origRect);
	UNREFERENCED_PARAMETER(*newRect);
}

CFont* CUgGridBase::GetEcDataFont()
{
	return &m_font;
}

CFont*  CUgGridBase::GetEcHeadFont()
{
	return &m_fontHead;
}

void CUgGridBase::SetGridEcStyle()
{
	// 设置表头文字字形
	CUGCell cellHead;
	GetHeadingDefault(&cellHead);
	cellHead.SetBackColor(RGB(213, 228, 242));
	cellHead.SetTextColor(RGB(21, 74, 147));
	cellHead.SetFont(GetEcHeadFont());

	SetHeadingDefault(&cellHead);
	...
	{ 
		for(int z = 0; z < GetNumberRows(); z++)
		{ 
			QuickSetAlignment(x, z, UG_ALIGNVCENTER | UG_ALIGNCENTER); 
		} 
	} 
...
void CUgGridBase::SelectLastEx()
{
	if (nLastStartCol < 0 || nLastStartRow < 0 || nLastEndCol < 0 || nLastEndRow < 0)
	{
		return;
	}

	int nMaxRow = GetNumberRows();
	int nMaxCol = GetNumberCols();

	if (nLastStartCol >= nMaxCol || nLastStartRow >= nMaxRow || nLastEndCol >= nMaxCol || nLastEndRow >= nMaxRow)
	{
		return;
	}

	SelectRangeEx(nLastStartCol, nLastStartRow, nLastEndCol, nLastEndRow);
}

void CUgGridBase::SelectRangeEx(int startCol, long startRow, int endCol, long endRow)
{
	...
	if (startCol >= nMaxCol || startRow >= nMaxRow || endCol >= nMaxCol || endRow >= nMaxRow)
	{
		return;
	}
	...
	{
		// 恢复颜色为白色
		for (int i = nLastStartCol; i <= nLastEndCol; ++i)
		{
			for (int j = nLastStartRow; j <= nLastEndRow; ++j)
			{
				GetCell(i, j, &cell);
	...
	for (int i = startCol; i <= endCol; ++i)
	{
		...
		{
			GetCell(i, j, &cell);
			cell.SetBackColor(RGB(255, 249, 132));
			SetCell(i, j, &cell);
		}
	}

	nLastStartRow = startRow;
	nLastEndRow = endRow;
	nLastStartCol = startCol;
	nLastEndCol = endCol;

	Invalidate();
}

void CUgGridBase::DeSelectAllEx()
{
	CUGCell cell;
	if (nLastStartCol != -1)
	{
