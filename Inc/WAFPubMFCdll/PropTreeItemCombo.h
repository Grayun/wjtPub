#if !defined(AFX_WAFPUBMFCDLLITEMCOMBO_H__9916BC6F_751F_4B15_996F_3C9F6334A259__INCLUDED_)
#define AFX_WAFPUBMFCDLLITEMCOMBO_H__9916BC6F_751F_4B15_996F_3C9F6334A259__INCLUDED_
...
/////////////////////////////////////////////////////////////////////////////
// CWAFPubMFCdllItemCombo window

class WAFPUBMFCDLL_API CPropTreeItemCombo : public CComboBox, public CPropTreelItem
{
// Construction
public:
	CPropTreeItemCombo();
...
public:
	...
	// --------------------------------------------------------------------------------
	// Summary: 
	//   增加数据 nTypeId用于索引，-1则默认使用加入顺序
	// --------------------------------------------------------------------------------
	int AddStringEx(LPCTSTR lpszString, int nTypeId = -1);
...
// Overrides
	...
	//{{AFX_VIRTUAL(CWAFPubMFCdllItemCombo)
	//}}AFX_VIRTUAL
...
protected:
	//{{AFX_MSG(CWAFPubMFCdllItemCombo)
...
#endif // !defined(AFX_WAFPUBMFCDLLITEMCOMBO_H__9916BC6F_751F_4B15_996F_3C9F6334A259__INCLUDED_)
