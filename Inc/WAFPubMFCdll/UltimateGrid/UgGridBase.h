// MyCUG.h : interface of the CEcUgGridBase class
//
#pragma once
/////////////////////////////////////////////////////////////////////////////
// --------------------------------------------------------------------------------
// Summary: 
//   自定义消息，当鼠标左键单击时响应并发送此消息
// Parameters:
//   WPARAM		-本参数记录的是当前网格控件的句柄
//   LPARAM		-本参数是一个结构体，里面记录的是鼠标左键单击时的行和列
// --------------------------------------------------------------------------------
#define WM_UGGRID_LEFT_CLICKED WM_USER + 10	
#define WM_UGGRID_DCLICKED WM_USER + 11	


#define WM_UGGRID_START_EDIT WM_USER + 15	
#define WM_UGGRID_END_EDIT WM_USER + 20
// 用来存储鼠标单击时产生的数据
struct UG_CLASS_DECL SUgGridData
{
	int col;
	int row;
};

class UG_CLASS_DECL CUgGridBase : public CUGCtrl
{
public:
	CUgGridBase();
	~CUgGridBase();
...
protected:
	...
	void SelectRangeEx(int startCol,long startRow,int endCol,long endRow);
