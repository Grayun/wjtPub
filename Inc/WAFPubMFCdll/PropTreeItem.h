...
class WAFPUBMFCDLL_API CPropTreelItem
{
// Construction
public:
	CPropTreelItem();
	virtual ~CPropTreelItem();
...
public:
	...
	CPropTreelItem* GetParent();
	CPropTreelItem* GetSibling();
	CPropTreelItem* GetChild();
	CPropTreelItem* GetNextVisible();

	void SetParent(CPropTreelItem* pParent);
	void SetSibling(CPropTreelItem* pSibling);
	void SetChild(CPropTreelItem* pChild);
	void SetNextVisible(CPropTreelItem* pVis);
...
private:
	...
	// link pointers
	CPropTreelItem*		m_pParent;
	CPropTreelItem*		m_pSibling;
	CPropTreelItem*		m_pChild;
	CPropTreelItem*		m_pVis;
};
